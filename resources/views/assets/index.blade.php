            ...
            <tbody class="divide-y divide-gray-200">
                @forelse ($assets as $asset)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-2">{{ $asset->purchase_date ? $asset->purchase_date->format('d/m/Y') : '-' }}</td>
                        <td class="px-4 py-2">{{ $asset->purchase_value ? number_format($asset->purchase_value, 2, ',', '.') : '-' }}</td>
                ...
                @empty
                    <tr>
                        <td colspan="17" class="px-4 py-3 text-center text-gray-500">Belum ada data asset.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
