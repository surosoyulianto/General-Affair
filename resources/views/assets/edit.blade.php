...
<div class="container mx-auto px-4 py-6">
    ...
    <form action="{{ route('assets.update', $asset->id) }}" method="POST" class="bg-white p-6 rounded shadow">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div class="col-span-2">
                ...
                <textarea name="description" rows="3" class="w-full border rounded p-2">{{ old('description', $asset->description) }}</textarea>
            </div>
        </div>
